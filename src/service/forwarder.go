...
func (f *Forwarder) ForwardEvent(roomIds []string, data model.AlertData) error {
...
func (f *Forwarder) forwardSingleEvent(roomID string, data model.AlertData) error {
...
func (f *Forwarder) sendResolvedReaction(roomID, eventID string, data model.AlertData) error {
...
func (f *Forwarder) sendResolvedReply(roomID, eventID string, data model.AlertData) error {
...
func (f *Forwarder) sendAlertMessage(roomID string, data model.AlertData) error {
